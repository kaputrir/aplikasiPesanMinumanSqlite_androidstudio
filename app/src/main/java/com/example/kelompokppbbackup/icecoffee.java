...
public class icecoffee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_icecoffee);
        ...
        proses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isInserted == true)
                    Toast.makeText(icecoffee.this,"Data Saved",Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(icecoffee.this,"Data Not Saved",Toast.LENGTH_SHORT).show();
            }
        });
    }
}